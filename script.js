...
import { getFirestore, collection, addDoc, serverTimestamp, GeoPoint } from "https://www.gstatic.com/firebasejs/9.6.1/firebase-firestore.js";
...
reportForm.addEventListener('submit', async (e) => {
    ...
    const reportData = {
        ...
        geoPoint: new GeoPoint(currentLocation.lat, currentLocation.lng),
        status: 'New',
        joinedUsers: []
    };
    ...
    try {
        ...
        alert("Failed to submit report. Please try again. Check console for details.");
    }
});
